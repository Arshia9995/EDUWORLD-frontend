...
// import { FiArrowLeft, FiSend, FiMessageSquare, FiUsers, FiSearch, FiInfo, FiCalendar } from 'react-icons/fi';
...
//     };
//   };
//   unreadCount?: number; // Added to match backend response
// }
...
//               ? { ...chat, lastMessage: response.data.messages }
//               : chat
//           )
//         );
//       } else {
...
//     // Mark messages as read for the current user (instructor)
//     try {
...
//       if (response.data.success) {
//         // Update the unread count for the selected chat to 0
//         setChats((prevChats) =>
//           prevChats.map((c) =>
...
//   // Get last message content with sender name
...
//       messageText += lastMessage.media.type === 'image'
//         ? 'Image'
...
//         return <p className="text-sm text-blue-600">[Image]</p>;
//       } else if (message.media.type === 'video') {
//         return <p className="text-sm text-blue-600">[Video]</p>;
//       } else {
//         return (
//           <a
...
//                           selectedChat?._id === chat._id ? 'border-blue-600 bg-blue-50' : 'border-transparent'
//                         }`}
//                       >
...
//                                   >
//                                     {showAvatar && (
//                                       <p className={`text-xs font-medium mb-1 ${isInstructor ? 'text-blue-100' : 'text-blue-600'}`}>
//                                         {message.senderId.name}
//                                       </p>
//                                     )}
//                                     {renderMessageContent(message)}
//                                     <p className={`text-xs ${isInstructor ? 'text-blue-100' : 'text-gray-400'} text-right mt-1`}>
...
import React, { useState, useEffect, useRef } from 'react';
import { useNavigate } from 'react-router-dom';
import { FiArrowLeft, FiSend, FiMessageSquare, FiUsers, FiSearch, FiInfo, FiCalendar, FiPaperclip } from 'react-icons/fi';
import InstructorSidebar from '../../../common/InstructorSidebar';
import { api } from '../../../config/api';
import toast from 'react-hot-toast';
